...
urlpatterns = [
    ...
    path('accept_friendrequestprofile/',AcceptFriendRequestProfileView.as_view(), name="accept_friendrequestprofile"),
    path('denine_friendrequestprofile/',DenineFriendRequestProfileView.as_view(), name="denine_friendrequestprofile"),
