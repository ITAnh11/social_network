...
from .views import ProfileView, ListFriendsView, SetUserProfileView, SetImageProfileView, GetProfileView, GetPostsView, GetUserProfileBasicView, GetMutualFriendView, GetStatusFriend, GetFriendShip
from .viewsEdit import EditImages, EditProfileView, EditStoryView
