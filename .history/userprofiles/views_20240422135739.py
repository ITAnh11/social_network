...
class GetMutualFriendView(APIView):
        def get(self, request):
            ...
            other_user_id = request.get('user_id')    #lấy từ fe của user kia, fe gửi lên sever id profile của người đó
            
            print(other_user_id)
            other_user = get_object_or_404(Friendship, id=other_user_id) # user_id1, user_id2
