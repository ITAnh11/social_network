            ...
            for friendship in user_friendships:
                ...
                if mutual_friendships_count >= 1:
                    ...
                    for mutual_friendship in mutual_friendships:
                        ...
                        suggestion_friend_profile = getUserProfileForPosts(mutual_friendship.user_id1)
                        if not Friendship.objects.filter(Q(user_id1=user, user_id2=suggestion_friend_profile.user) | Q(user_id1=suggestion_friend_profile.user, user_id2=user)).exists():
