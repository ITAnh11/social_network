...
function show_list_other_user(){
    ...
    .then(data => {
        ...
        data.data.forEach(function(request){
                ...
                var a = `<div class="card1" id="${request.friend_request_send.id}">
                <div class="card1-img">
                    <img style="object-fit: cover;width: 100%;height: 100%;" src="${request.friend_request_profile.avatar}" alt="Card Image" >
                </div>
                <div class="card1-content">
                ...
                <div class="card1-button">
                    <button class="button1" onclick="accept_button(event)">Thêm bạn bè</button>
                    <button class="button2" onclick="denine_button(event)">Xóa</button>
                </div>
            </div>`;
            var newDiv = document.createElement("div");
            newDiv.innerHTML = a;
