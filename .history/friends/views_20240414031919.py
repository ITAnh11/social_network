        ...
        def get(self, request):
            ...
            for friendship in user_friendships:
                ...
                if mutual_friendships_count >= 1:
                    ...
                    friend_profile = getUserProfileForPosts(friendship.user_id1, friendship.user_id2) 
                    
                    if not Friendship.objects.filter(Q(user_id1=user, user_id2=friend_profile.user) | Q(user_id1=friend_profile.user, user_id2=user)).exists():
