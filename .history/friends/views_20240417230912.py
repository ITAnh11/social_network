...
class GetSuggestionFriendView(APIView):
        def get(self, request):
            ...
            other_users = Friendship.objects.exclude(
            ...
            for other_user in other_users:
                ...
                suggestions = {
                    "other_user_profile": getUserProfileForPosts(other_user.user_id2) if user == other_user.user_id1 else getUserProfileForPosts(other_user.user_id1)  
                    }
